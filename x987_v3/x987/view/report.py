...
BUILTIN_PAINTS = {
    "arctic silver metallic":"#C9CCCE","classic silver metallic":"#C6C9CB",
    "meteor gray":"#6E7479","gray":"#8F969C","black":"#0C0E10","white":"#E9EAEA",
    "guards red":"#D0191A","red":"#B0201B","carrara white":"#EDEDED",
    "aqua blue metallic":"#2E6C8E","malachite green metallic":"#2C5F51",
    "silver":"#C9CCCE","midnight blue metallic":"#1A2C4E","basalt black metallic":"#0B0F14",
}
...
def print_table(rows: Iterable[dict]) -> None:
    ...
    table=Table(
        ...
        border_style="black",
        padding=(0, 1),
        row_styles=["", bg_style("stripe_1")],
    )

    table.add_column("Deal",  justify="right",  no_wrap=True, min_width=9,       max_width=9)
    table.add_column("Price", justify="right",  no_wrap=True, min_width=5,       max_width=5)
    table.add_column("Miles", justify="right",  no_wrap=True, min_width=5,       max_width=5)
    table.add_column("Year/Model/Trim",         no_wrap=True, min_width=20,      max_width=24)
    table.add_column("Colors", no_wrap=True, min_width=10, max_width=10)
    ...
    for r in rows:
        deal_raw=r.get("deal_delta") or r.get("Deal Δ ($)") or r.get("Deal") or ""
